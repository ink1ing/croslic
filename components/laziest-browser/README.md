## MacPad Browser Routes

One-liner: MacPad's bundled Chrome prefix router, with drag reorder, quick-start onboarding, and built-in AI / Browser / Web3 routes.
...
## Preset Shortcuts
New installs begin with all built-in AI, Browser, and Web3 shortcuts. Head to Options to edit them, restore defaults, or add entries manually:
